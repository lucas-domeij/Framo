...
server.registerTool(
  "frame-screenshot",
  {
    ...
    inputSchema: {
      imagePath: z
        .string()
        .describe("Absolute path to the input screenshot image"),
      outputPath: z
        .string()
        .optional()
        .describe(
          "Output path for the framed image. Defaults to <imagePath>-framed.png",
        ),
      preset: z
        .string()
        .optional()
        .describe(`Gradient preset name. Available: ${presetNames.join(", ")}`),
      padding: z
        .number()
        .optional()
        .describe("Padding around the image in pixels (default: 64)"),
      borderRadius: z
        .number()
        .optional()
      ...
      noiseEnabled: z
        ...
        .optional()
        .describe(
          "Enable noise texture on the gradient background (default: false)",
        ),
      glowEnabled: z
        .boolean()
        .optional()
  ...
  async (params) => {
    ...
    const outputPath = params.outputPath
      ...
      : join(dir, `${base}-framed-${timestamp}.png`);
    ...
    if (params.shadowEnabled !== undefined)
      settings.shadowEnabled = params.shadowEnabled;
    if (params.shadowIntensity !== undefined)
      settings.shadowIntensity = params.shadowIntensity;
    if (params.noiseEnabled !== undefined)
      settings.noiseEnabled = params.noiseEnabled;
    if (params.glowEnabled !== undefined)
      settings.glowEnabled = params.glowEnabled;
